 ...
 <div className="rounded-xl m-1 lg:m-10 grid lg:grid-cols-2 gap-10 lg:gap-20 xl:gap-40 mt-5 lg:mt-20 p-5">
  ...
  <div className="flex justify-center items-center lg:justify-start lg:items-start">
    <img src="https://m.media-amazon.com/images/I/61ok2B7A5wL._AC_UY436_FMwebp_QL65_.jpg" className="w-110 p-2 lg:p-5"/>
  </div>
  <div className="lg:p-5">
    <h2 className="text-3xl font-bold underline underline-offset-3 text-center lg:text-start">Future Science & Technology</h2>
    ...
    <p className="mt-10 text-xl text-justify font-stretch-120% font-serif mr-3 ml-3 sm:mr-10 sm:ml-10 lg:mr-0 lg:ml-0">
      What is nanotechnology? What is intelligence? How do robots work? This encyclopedia will answer these and more whats and hows for you. Learning is made simpler with well-labelled diagrams, and an extensive glossary of difficult words. Bonus: the book comes loaded with Isn’ t It Amazing — a section of fun facts to keep you glued for more.
