 ...
 export function EncyclopediaBook () {
 ...
 <div className="rounded-xl m-1 lg:m-10 grid lg:grid-cols-2 gap-10 lg:gap-20 xl:gap-40 mt-5 lg:mt-20 p-5">
  ...
  <div className="flex justify-center items-center lg:justify-start lg:items-start">
    <img src="https://m.media-amazon.com/images/I/71NGK8HznhL._AC_UY436_FMwebp_QL65_.jpg" className="w-110 p-2 lg:p-5"/>
  </div>
  <div className="lg:p-5">
    <h2 className="text-3xl font-bold underline underline-offset-3 text-center lg:text-start">Space Encyclopedia</h2>
    <h3 className="text-center lg:text-start mt-1">By Om Books Editorial Team</h3>
    <p className="mt-10 text-xl text-justify font-stretch-120% font-serif mr-3 ml-3 sm:mr-10 sm:ml-10 lg:mr-0 lg:ml-0">
     When did humans begin to explore space? How did they save themselves from the hazards of Radiation and vacuun? What is it like for an astronaut to travel in space? This book is packed with interesting facts about the incredible milkyway galaxy, the brightest stars, the solar system, the dwarf planets and much more! This book is a boon for all budding astronauts and space wizards!.
